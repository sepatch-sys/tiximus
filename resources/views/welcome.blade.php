<x-app-layout>
    <div class="min-h-screen bg-gray-100">
        ...
        <!-- Kotak Penjelasan -->
        <div
            class="w-full py-8 md:py-10 px-6 shadow-lg text-center bg-gradient-to-r from-orange-500 via-yellow-400 to-blue-400 animate-wave-background">
        ...
        <div class="mb-6">
            <div class="flex flex-wrap justify-center gap-6 py-6">
                ...
                <a href="{{ route('tickets.all') }}" class="group flex flex-col items-center cursor-pointer">
                    <div
                ...
                <div class="group flex flex-col items-center cursor-pointer">
                    ...
                    <p class="mt-3 font-semibold text-lg text-gray-800 group-hover:text-yellow-500 transition-all">Event
                    </p>
                </div>
                ...
                <div class="group flex flex-col items-center cursor-pointer">
                    ...
                    <p class="mt-3 font-semibold text-lg text-gray-800 group-hover:text-yellow-500 transition-all">Tour
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="relative overflow-hidden">
                    <div class="flex items-start gap-6 transition-transform duration-500" id="province-container">
                        ...
                        <div class="relative w-48 h-72 rounded-3xl overflow-hidden shadow-lg group flex-shrink-0">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                                <h3 class="text-xl font-semibold text-white text-center px-4">
                                    {{ $randomProvince->province_name }}</h3>
                            </div>
                        </div>
